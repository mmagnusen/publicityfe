...
export const toggleHeading = (editor: Editor | null, level: Level): void => {
	if (!editor) return;
...
export const isHeadingButtonDisabled = (
	editor: Editor | null,
	level: Level,
...
export const shouldShowHeadingButton = (params: {
	editor: Editor | null;
...
export const getFormattedHeadingName = (level: Level): string => {
